...
\chapter{FUNDAMENTOS DA ALEATORIEDADE EM COMPUTAÇÃO} % Capitulo 2
    ...
    \section{Avaliação Estatística da Aleatoriedade}
        ...
        Falar separadamente sobre cada um dos 15 testes. Mostrando um teste local separado. (Seguir documentacao do guthub para execucao local)
        \cite{6.4NISTGit}
        ...
        %PASSO 2 - Explicacao do resultado do (Teste de Frequência (monobit))
