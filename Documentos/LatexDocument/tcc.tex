...
\chapter{FUNDAMENTOS DA ALEATORIEDADE EM COMPUTAÇÃO} % Capitulo 2
    ...
    \section{Avaliação Estatística da Aleatoriedade}
        ...
        \subsection{Teste de Frequência em Bloco}
            ...
            \begin{figure}[htb]
                    \centering
                    \caption{Resultado final do Teste de Frequência em Bloco para Random}\label{fig:frequency_within_block_test_segure}
                    \includegraphics[width=0.8\textwidth]{frequency_within_block_test_segure.png}
                    \legend{Fonte: Elaborado pelo autor (2026)}
            \end{figure}
        ...
        %PASSO 6 - Explicacao do resultado do (Teste da Transformada Discreta ded Fourier (Espectral))
        %PASSO 7 - Explicacao do resultado do (Teste de Correspondência ded Modelos não Sobrepostos)
